...
def errorprone_with_custom_plugins(name, errorprone, plugins = [], **kwargs):
    ...
    java_library(
        ...
        exports = [
            errorprone,
            "@rules_java//java_tools/buildjar/java/com/google/devtools/build/buildjar/javac/plugins:errorprone",
        ] + plugins,
        **kwargs
    )

def default_javabuilder(name, errorprone = [], javabuilder_core = "@rules_java//java_tools/buildjar:javabuilder_core", **kwargs):
